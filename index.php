<?php include "navbar.php" ?>
  ...
  /* Exact Design Match for Image */
  .image-container {
    position: relative;
    padding: 40px 0; /* Creates space for top/bottom teal background to show */
    display: flex;
    align-items: center;
  }
  .image-backdrop {
    position: absolute;
    top: 0;
    right: 0; /* Teal background shifted to the right */
    width: 65%;
    height: 100%;
  ...
  .main-img {
    position: relative;
    z-index: 2;
    width: 85%; /* Image slightly smaller to show background */
    margin-right: auto; /* Aligns image to the left over the right-side backdrop */
  ...
  .carousel-indicators-custom {
      position: absolute;
      right: 6%; /* Placed over the exposed right teal area */
      top: 50%;
  ...
  .carousel-indicator-square {
      width: 16px;
      height: 16px;
      border: 2px solid white;
      cursor: pointer;
  }
  .carousel-indicator-square.active {
      background-color: white;
  }
  
  /* Form and Floating Icons */
  .form-card {
    background: white;
    padding: 35px;
    border-radius: 12px;
        ...
        <div class="row g-5 align-items-center mb-5">
            ...
            <div class="col-lg-7">
                <div class="image-container">
                    <!-- Teal backdrop on the right -->
                    <div class="image-backdrop"></div>
                    <!-- Image overlapping on the left -->
                    <img class="img-fluid main-img" src="img/hero-slider-1.jpg" alt="Interior">
                    
                    <!-- Square Carousel Indicators -->
                    <div class="carousel-indicators-custom">
                        <div class="carousel-indicator-square active"></div>
                        <div class="carousel-indicator-square"></div>
                        <div class="carousel-indicator-square"></div>
                    </div>
                </div>
            </div>
